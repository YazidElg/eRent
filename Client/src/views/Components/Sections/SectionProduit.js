          ...
          <GridItem xs={12} sm={12} md={4}>
            <Card className={classes[cardAnimaton]}>
              ...
              <GridItem xs={12} sm={12} md={6} className={classes.itemGrid}>
                <img
                  src="https://i.pinimg.com/originals/33/89/32/3389325e9751732d99812f5637edc963.jpg"
                  alt="..."
              ...
              <CardBody>
                <p className={classes.description}>
                  Appartements meublés de 1 à 2 personnes 25 m². À proximité de
                  Carrefour et de l'école supérieur de technologie de salé, avec
                  wifi et salle de bain
                </p>
